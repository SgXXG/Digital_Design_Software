...
HD_PWD='D:/vivado/DOP_Zmeika/DOP_Zmeika.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sSegDemo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sSegDemo.tcl -notrace
