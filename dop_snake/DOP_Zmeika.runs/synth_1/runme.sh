...
HD_PWD='D:/vivado/DOP_Zmeika/DOP_Zmeika.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sSegDemo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sSegDemo.tcl
