...
HD_PWD='D:/vivado/mux_complete/mux_complete.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_sknf.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_sknf.tcl -notrace
