...
HD_PWD='D:/vivado/mux_complete/mux_complete.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_sknf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_sknf.tcl
