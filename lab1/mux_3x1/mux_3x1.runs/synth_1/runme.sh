...
HD_PWD='D:/vivado/mux_3x1/mux_3x1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_3x1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_3x1.tcl
