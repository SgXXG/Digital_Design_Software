...
HD_PWD='D:/vivado/mux_3x1/mux_3x1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_3x1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_3x1.tcl -notrace
