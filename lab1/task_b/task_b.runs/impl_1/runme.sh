...
HD_PWD='D:/vivado/task_b/task_b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log task_b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source task_b.tcl -notrace
