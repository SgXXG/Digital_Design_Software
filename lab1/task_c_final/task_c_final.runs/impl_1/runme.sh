...
HD_PWD='D:/vivado/task_c/task_c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log task_c.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source task_c.tcl -notrace
