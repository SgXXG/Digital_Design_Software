...
HD_PWD='D:/vivado/task_d/task_d.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log task_d.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source task_d.tcl -notrace
